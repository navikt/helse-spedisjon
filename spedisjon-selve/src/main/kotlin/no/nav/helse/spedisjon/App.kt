...
fun main() {
    ...
    LogWrapper(RapidApplication.create(env), meldingMediator).apply {
        ...
        if (erUtvikling) NyeArbeidsledigSøknader(this, meldingMediator)
        ...
        if (erUtvikling) FremtidigArbeidsledigSøknaderRiver(this, meldingMediator)
        ...
        if (erUtvikling) SendteArbeidsledigSøknader(this, meldingMediator)
