...
class V4__test_migrering_av_duplikatkontroll() : BaseJavaMigration() {
    ...
    private companion object {
        ...
        private val log = LoggerFactory.getLogger(V4__test_migrering_av_duplikatkontroll::class.java)
        @Language("PostgreSQL")
        private const val SELECT =
            "SELECT id, data FROM melding WHERE type IN('ny_søknad','sendt_søknad_arbeidsgiver','sendt_søknad_nav') AND tmp_duplikatkontroll IS NULL ORDER BY id"
